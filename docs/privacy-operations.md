...
| Public comment | AI-generated body from public ticker evidence, ticker, internal account link, stable thread emoji alias | Comment authors | Generate and publish the comment the member requested; contract | Hosting and public readers | Until author deletes it or deletes the account |
