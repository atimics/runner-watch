...
DEFAULT_SOURCE_POLICIES = (
    SourcePolicy(
        ...
        attribution="Helius; USD pool quotes from GeckoTerminal",
    ...
    SourcePolicy(
        ...
        title="U.S. House financial disclosure filing index",
        owner="Office of the Clerk, U.S. House of Representatives",
        terms_url="https://disclosures-clerk.house.gov/FinancialDisclosure/ViewSearch",
        credential_env=None,
        ...
        attribution="Office of the Clerk, U.S. House of Representatives",
        review_status="review_required",
        enabled=_enabled("HOUSE_DISCLOSURES_ENABLED"),
    ),
    SourcePolicy(
        source="house_clerk",
        feed="house_ptr",
        title="U.S. House periodic transaction reports",
        owner="Office of the Clerk, U.S. House of Representatives",
        terms_url="https://disclosures-clerk.house.gov/FinancialDisclosure/ViewSearch",
        credential_env=None,
        expected_cadence_seconds=None,
