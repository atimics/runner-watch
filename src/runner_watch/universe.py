...
STARTER_SYMBOLS = [
    ...
    "CLSK", "COIN", "CORZ", "CRDO", "CRSP", "CVNA", "DJT", "DKNG", "DNA", "DUOL",
    "ENVX", "ETHA", "F", "FIG", "FUBO", "GME", "GOEV", "GOOGL", "GRAB", "HOOD",
    "HUT", "IBIT", "IONQ", "IREN", "JOBY", "LCID", "LUNR", "MARA", "META", "MSTR",
    "MU", "NBIS", "NIO", "NKLA", "NVDA", "OKLO", "OPEN", "ONDS", "ORCL", "OSCR",
    "PATH", "PLTR", "QBTS", "QUBT", "RGTI", "RIVN", "RKLB", "ROKU", "RXRX", "SAVA",
    "SBUX", "SERV", "SHOP", "SLV", "SMCI", "SNAP", "SOFI", "SOUN", "SPCE", "TIGR",
    "TMC", "TSLA", "TSM", "TSSI", "U", "UBER", "UPST", "VFS", "VKTX", "WBD",
    "WOLF", "XPEV", "ZETA", "ZM",
]
...
def _looks_like_common_stock(name: str) -> bool:
    blocked = (
        ...
        " preferred", " notes due", " bond", " debenture",
    )
