...
def test_ranker_prediction_becomes_one_immutable_flash_call(
    ...
    assert calls[0]["inference_model"] == "deepseek/deepseek-v4.1-flash"
    assert calls[0]["inference_model_label"] == "DeepSeek V4.1 Flash"
    ...
    assert frozen_call["inference_model"] == "deepseek/deepseek-v4.1-flash"
    assert frozen_call["inference_model_label"] == "DeepSeek V4.1 Flash"
